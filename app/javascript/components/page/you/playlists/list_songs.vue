<template lang="html">
  <div
    class="flex justify-around items-center bg-gray-900 aaa"
    @mouseover="mouseOver"
  ...
  >
    ...
    <button class=" text-start" @click="remove">
      <i class="fas fa-window-close"></i>Remove
    </button>

    <div class="flex-row justify-center md:justify-start md:w-1/12">
      <i
        class="fas fa-play cursor-pointer"
        @click="playTheSong"
        v-if="playBtn && !playing"
      ></i>
